...
export const useCoreOAuthConfig = (oauthActionText: string): TOAuthConfigs => {
  ...
  const oAuthOptions: TOAuthOption[] = [
    ...
    {
      id: "cenhomes",
      text: `${oauthActionText} with Cenhomes ID`,
      icon: <img src={cenhomesLogo} height={18} width={18} alt="Cenhomes Logo" />,
      onClick: () => {
        window.location.assign(`${API_BASE_URL}/auth/cenhomes/${next_path ? `?next_path=${next_path}` : ``}`);
      },
      enabled: config?.is_cenhomes_enabled,
    },
  ];
