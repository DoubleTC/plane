  ...
  return (
    <span className="flex items-center justify-center py-6">
      <p className="text-center text-13 whitespace-pre-line text-secondary">
        ...
        <a href="https://pm.cenz.pro/legals/terms-and-conditions" target="_blank" rel="noopener noreferrer">
          <span className="text-13 font-medium underline hover:cursor-pointer">Terms of Service</span>
        </a>{" "}
        and{" "}
        <a href="https://pm.cenz.pro/legals/privacy-policy" target="_blank" rel="noopener noreferrer">
