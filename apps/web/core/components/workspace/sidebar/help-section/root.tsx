  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        closeOnSelect
      >
        {/*<CustomMenu.MenuItem onClick={() => window.open("https://go.pm.cenz.pro/p-docs", "_blank")}>*/}
        {/*  <div className="flex items-center gap-x-2 rounded-sm text-11">*/}
        {/*    <PageIcon className="h-3.5 w-3.5 text-secondary" height={14} width={14} />*/}
        {/*    <span className="text-11">{t("documentation")}</span>*/}
        {/*  </div>*/}
        {/*</CustomMenu.MenuItem>*/}
        {/*<CustomMenu.MenuItem onClick={() => window.open("mailto:sales@pm.cenz.pro", "_blank")}>*/}
        {/*  <div className="flex items-center gap-x-2 rounded-sm text-11">*/}
        ...
        {/*</CustomMenu.MenuItem>*/}
        <div className="my-1 border-t border-subtle" />
        <CustomMenu.MenuItem onClick={() => window.open("https://doubletc.com", "_blank", "noopener,noreferrer")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
            <span className="text-11">Double TC</span>
          </div>
        </CustomMenu.MenuItem>
