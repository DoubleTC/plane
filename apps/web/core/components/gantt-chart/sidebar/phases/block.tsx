...
import { PhaseGanttSidebarBlock } from "@/components/phases";
// hooks
...
export const PhasesSidebarBlock = observer(function PhasesSidebarBlock(props: Props) {
      ...
      >
        <div className="flex h-full flex-grow items-center justify-between gap-2 truncate">
          <div className="flex-grow truncate">
            <PhaseGanttSidebarBlock phaseId={block.data.id} />
          </div>
          {duration !== undefined && (
