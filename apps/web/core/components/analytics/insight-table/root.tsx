...
interface InsightTableProps<T extends Exclude<TAnalyticsTabsBase, "overview" | "projects" | "members">> {
  analyticsType: T;
...
export function InsightTable<T extends Exclude<TAnalyticsTabsBase, "overview" | "projects" | "members">>(
