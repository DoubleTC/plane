...
import { PhasesTimeLineStore } from "@/store/timeline/phases-timeline.store";
import type { IPhasesTimeLineStore } from "@/store/timeline/phases-timeline.store";
...
export interface ITimelineStore {
  ...
  phasesTimeLineStore: IPhasesTimeLineStore;
...
export class TimeLineStore implements ITimelineStore {
  ...
  constructor(rootStore: RootStore) {
    ...
    this.phasesTimeLineStore = new PhasesTimeLineStore(rootStore);
    // Dummy store
