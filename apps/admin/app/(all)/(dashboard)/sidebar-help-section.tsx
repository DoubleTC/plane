...
const helpOptions = [
  {
    name: "Documentation",
    href: "https://docs.pm.cenz.pro/",
    Icon: PageIcon,
  },
  {
    name: "Join our Forum",
    href: "https://forum.pm.cenz.pro",
    Icon: MessageSquare,
  },
  {
    name: "Report a bug",
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to BananaZ" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to BananaZ"}
          </a>
        </Tooltip>
