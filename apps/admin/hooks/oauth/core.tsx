...
// components
import { CenhomesConfiguration } from "@/components/authentication/cenhomes-config";
...
export const getCoreAuthenticationModesMap: (
  ...
  "unique-codes": {
    ...
    name: "Unique codes",
    description:
      "Log in or sign up for BananaZ using codes sent via email. You need to have set up SMTP to use this method.",
  ...
  google: {
    key: "google",
    name: "Google",
    description: "Allow members to log in or sign up for BananaZ with their Google accounts.",
  ...
  github: {
    key: "github",
    name: "GitHub",
    description: "Allow members to log in or sign up for BananaZ with their GitHub accounts.",
    icon: (
      <img
  ...
  cenhomes: {
    ...
    icon: <img src={cenhomesLogo} height={20} width={20} alt="Cenhomes Logo" />,
    config: <CenhomesConfiguration disabled={disabled} updateConfig={updateConfig} />,
    enabledConfigKey: "IS_CENHOMES_ENABLED",
  },
});
